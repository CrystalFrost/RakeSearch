...
void RakeSearch::PermuteRows()
{
	...
	unsigned int rowsHistoryFlags[Rank] = { 510, 509, 507, 503, 495, 479, 447, 383, 255 };	// Битовые флаги истории задействования строк в рамках текущей комбинации, где i-е значение - это маска использования строк вместо i-й строки квадрата B
	// Важная деталь! В состав битовых флаго истории зайдействования строк, уже включён фильтр, отсеивающий комбинацию, приводящую к исходному квадрату
